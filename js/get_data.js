...
const company = document.querySelector('#company_name');            // получаем из нашего файла элемент с id company_name
const interval = document.querySelector('#interval');               // получаем из нашего файла элемент с id interval
const numberOfRecords = document.querySelector('#numberOfRecords'); // получаем из нашего файла элемент с id numberOfRecords
const date = document.querySelector('#date');                       // получаем из нашего файла элемент с id date
